...
public class FtpFileSender implements Sender{
	...
	public String envoyerFichier(String url,String fileName,InputStream content){
		...
		try {
			 ...
			 * (solution optimiste)
			 */
        	response = "reponse autog�n�r�e : le transfert s'est bien effectu�";
        	os.close();
        	
        	//dans les cas ou il y a eu une exception lev�e on l'indique dans la phrase de retour
		} catch (MalformedURLException e) {
			// TODO Auto-generated catch block
			response = "reponse autog�n�r�e: mauvais transfert : URL malform�";
			e.printStackTrace();
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			
			response = "reponse autog�n�r�e: probleme avec la cible"+e.toString();
		}
