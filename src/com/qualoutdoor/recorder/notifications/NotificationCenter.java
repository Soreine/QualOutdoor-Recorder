...
public class NotificationCenter {
	...
	public static void notifyBackgroundSampling(Activity activity) {
		...
		notificationBuilder.setContentTitle(activity.getResources().getText(
				R.string.notification_sampling_title));
		// Set the notification text
		notificationBuilder.setContentText(activity.getResources().getText(
	...
	public static void dismissBackgroundSampling(FragmentActivity activity) {
		// Get the notification manager from the host activity
		NotificationManager mNotificationManager = (NotificationManager) activity
				.getSystemService(Context.NOTIFICATION_SERVICE);
